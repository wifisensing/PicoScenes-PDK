...
set(CMAKE_INSTALL_PREFIX ${INSTALL_PLUGIN_DIR})
...
elseif(WIN32)
    ...
    set(CPACK_NSIS_INSTALL_ROOT "C:\\\\ProgramData")
    string(REPLACE "/" "\\\\" CPACK_PACKAGE_INSTALL_DIRECTORY "${CMAKE_INSTALL_PREFIX}")
    set(CPACK_NSIS_PACKAGE_NAME "PicoScenes Plugins Demo, Echoprobe, Forwarder ${CPACK_PACKAGE_VERSION}")
    set(CPACK_NSIS_DISPLAY_NAME "${CPACK_NSIS_PACKAGE_NAME}")
    set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "${CPACK_PACKAGE_NAME}")
    set(CPACK_NSIS_URL_INFO_ABOUT "https://ps.zpj.io")
    set(CPACK_NSIS_HELP_LINK "https://ps.zpj.io")
    set(CPACK_NSIS_CONTACT "https://ps.zpj.io")
else()
    ...
    set(CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA ${CMAKE_CURRENT_LIST_DIR}/packaging/Ubuntu/postinst ${CMAKE_CURRENT_LIST_DIR}/packaging/Ubuntu/postrm)
